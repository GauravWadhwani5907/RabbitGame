...
function eat() {
  ...
  destroy(({costume: "carrot"}));
  if (getProp(({costume: "brown bunny"}), "scale") >= 250) {
...
function change_theme() {
  setBackgroundImageAs("sci_fi");
  setAnimation(({costume: "brown bunny"}), "purple bunny");
}
...
showTitleScreen('Press: Down to start rabbit game ', 'Press: Up to get carrot, Press: Right to eat carrot - Play until Rabbit says to restart');
